...
class ProductoController extends Controller
{
    ...
    public function createProducto()
    {
        ...
        return view('adm.producto.crearProducto', compact('usuario', 'marcas', 'productos_seccion', 'productos_create', 'subfamilias', 'familias'));
    }
    ...
    public function showProducto(Request $request)
    {
        ...
        return view('adm.producto.editarProductos', compact('productos', 'usuario', 'subfamilias_seccion', 'subfamilias_edit'));
    }
    ...
    public function editProducto($id)
    {
        ...
        $marcas = Marca::orderBy('order','ASC')->get();
        $subfamilias = Subfamilia::orderBy('order','ASC')->get();
        return view('adm.producto.editarProducto', compact('producto', 'usuario', 'subfamilias_seccion', 'subfamilias_edit', 'familias', 'subfamilias', 'marcas'));
    }
    ...
    public function createMarca()
    {
        ...
        return view('adm.producto.crearMarca', compact('usuario', 'marcas_seccion', 'marcas_create'));
    }
    ...
    public function storeMarca(Request $request)
    {
        ...
        $file_save = Helpers::saveImage($request->file('image'), 'marcas');
        $file_save ? $datos['image'] = $file_save : false;

        $marca = Marca::create($datos);
        $success = 'Marca creada correctamente';
        return Redirect::to('adm/producto/marca/show')->with('success', $success);
    }
    ...
    public function showMarca()
    {
        ...
        $marcas_seccion = 'active';
        $marcas_edit = 'active';
        return view('adm.producto.editarMarcas', compact('marcas','usuario','marcas_seccion','marcas_edit'));
    }
    ...
    public function editMarca($id)
    {
        ...
        $marcas_seccion = 'active';
        $marcas_edit = 'active';
        return view('adm.producto.editarMarca', compact('marca','usuario','marcas_seccion','marcas_edit'));
    }
